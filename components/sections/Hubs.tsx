...
const T: Record<Locale, Labels> = {
  fr: {
    ...
    tokyoPrestaDesc: "ESN française à Tokyo. Consultants JLPT N2+ bilingues. Money Forward, Cartier, Le Monde. Higashi-Azabu depuis 2018.",
  ...
  en: {
    ...
    tokyoPrestaTitle: "Tech consulting Tokyo & IT staffing Japan",
    tokyoPrestaDesc: "French firm in Tokyo. JLPT N2+ bilingual consultants. Money Forward, Cartier, Le Monde. Higashi-Azabu since 2018.",
    tokyoRecrutTitle: "Engineering jobs & tech recruitment Tokyo",
  ...
  ja: {
    ...
    tokyoPrestaDesc: "東京のフランス系ファーム。JLPT N2+バイリンガルコンサルタント。マネーフォワード、カルティエ、ル・モンド。麻布十番、2018年から。",
  ...
  "fr-ca": {
    ...
    tokyoPrestaTitle: "Tech consulting Tokyo & IT staffing Japan",
    tokyoPrestaDesc: "Firme française à Tokyo. Consultants JLPT N2+ bilingues. Money Forward, Cartier, Le Monde. Higashi-Azabu depuis 2018.",
    tokyoRecrutTitle: "Engineering jobs & tech recruitment Tokyo",

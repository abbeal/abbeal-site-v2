...
export function Services({
  ...
  return (
    <section id="services" className="bg-[var(--color-ink)] text-[var(--color-bg-light)]">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          {d.services.items.map((item, i) => (
            <motion.article
              ...
              className="group relative border border-[var(--color-bg-light)]/12 p-8 hover:border-[var(--color-brand-teal)]/60 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <Link
                href={`${p}/contact`}
                className="mt-8 inline-flex items-center gap-2 text-sm text-[var(--color-brand-teal)] hover:gap-3 transition-all"
              >
                {item.cta}
